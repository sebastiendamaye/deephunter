...
For example, to install version 2.6:

.. code-block:: sh

   $ wget https://raw.githubusercontent.com/sebastiendamaye/deephunter/main/install/scripts/v2.6/installer-v2.6.sh
   $ chmod +x installer-v2.6.sh
   $ ./installer-v2.6.sh
